	...
	<div class="container-fluid col-md-12 text-center padding">
		...
		<form action="" method="post">
			<div style="background-color:#F4F6F7;" class="modal-body text-center">
				<h3 style="color:red">Login</h3><hr/>
				...
				<tr>
				  <td colspan="2" rowspan="2"><button style="border-radius:10px;background-color:#E59866;margin-left:40%;padding:8px; width:150px;" type="submit" name="log" class="" id="submitbtn">Login</button></td>
				</tr>
				</table>
				<small class="black">Already have an account? </small><a href="SignupHos.php"><u>SignUp Here</u></a>
			</div>
		</form>
...
if(!empty($_POST['Username']) && !empty($_POST['Password1'])) {
    ...
    $query=mysql_query("SELECT * FROM hospitalinfo WHERE Username='".$Username."' AND Password1='".$Password1."'");
    ...
    $dbPassword1=$row['Password1'];
    }

    if($Username == $dbUsername && $Password1 == $dbPassword1)
    {
