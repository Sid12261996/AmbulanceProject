  ...
  <div class="modal-dialog" role="document">
  	...
  	<form action="Register.php" method="post">
  		<div class="modal-body text-center">
            ...
            <tr>
              <td>First Name:</td>
              <td><input type="text" name="First Name " placeholder="First Name" class="Textbox" id="Fname"></td>
            </tr>

            <tr>
              <td>Last name</td>
              <td><input type="text" name="Last Name " placeholder="Last Name" class="Textbox"></td>
            </tr>

            <tr>
              <td>Mobile number</td>
              <td><input type="text" name=" Mobile Number" value="" placeholder="10 Digits only" class="Textbox"></td>
            </tr>
            ...
            <tr>
              ...
              <td><input type="password" name="Confirm password " value="" class="Textbox"></td>
            </tr>

            <tr>
              <td colspan="2" rowspan="2"><button type="submit" name="Button" class="" id="submitbtn">Sign Up</button></td>
            </tr>
          </table>
  		</div>
